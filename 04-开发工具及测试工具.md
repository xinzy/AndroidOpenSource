...
效果图：
![Holo Colors Idea](imgs/Parcelable-boilerplate-code-generation.png)  
...
效果图：
![Holo Colors Idea](imgs/HoloColorsIntelliJPlugin.png)  

1. Android Drawable Factory  
用于生成各个分辨率的图片  
项目地址：https://github.com/tizionario/AndroidDrawableFactory  
效果图：
![Android Drawable Factory](imgs/AndroidDrawableFactory.png)  
...
效果图：
![Renderings](imgs/eventbus-intellij-plugin.gif)
