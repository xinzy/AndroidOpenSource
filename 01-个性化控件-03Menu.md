...
效果图：  
![Renderings](imgs/CircularMenu1.png)
![Renderings](imgs/CircularMenu2.png)

1.SpringFloatingActionMenu  
点击 FAB 会弹出菜单,并有动画效果的库  
项目地址：https://github.com/tiancaiCC/SpringFloatingActionMenu  
![Renderings](imgs/SpringFloatingActionMenu.gif)  
